...
```env
TRADE_OPS_IMAGE=ghcr.io/naoufalelbani/trade-ops-sentinel-freqtrade:v0.2.6
```
...
docker buildx build \
  ...
  -t ghcr.io/naoufalelbani/trade-ops-sentinel-freqtrade:v0.2.6 \
  --push .
```
...
| `APP_VERSION` | `v0.2.6` | Build/version label shown on startup and `/version` |
